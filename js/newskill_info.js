...
/*    $("#fellowbtn").unbind('click');
    ...
    $('#toshortcut').bind("click", function() {
    	$('#toshortcut').removeClass('guide_bag_btn');
			$('#toshortcut').addClass('bag_btn');
        shortcutskill();
    });
...
{
						$('#chooseskill').removeClass('guide_bag_icon');
						$('#chooseskill').addClass('bag_icontext');
		  	  	$.post("./dispatchers/dispatcher.php", {theid: ""+theid+"" ,  what: "gettheskillinfo" },
	  	  	 function(data){  
	  	  	 	displayaskillinfo(data); 
	  	  	 	newbieinstruct20(msg20);
	  	  	 	},'json'
	  	  				); 	
}
