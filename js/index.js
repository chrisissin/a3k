...
$(document).ready(function() {
    ...
    $('#storeindex').click(function() {
      ...
      .appendTo('body');
        ...
        $('#lshopbtn').click(function() { $('#storeindex').click();});
    ...
    $('#statusbtn').click(function() {
        ...
        $('#popup').load('./player_info.html', {}, function() { // default at player info window
            $(this).showPopup();
            var tool = $('#maindiv');
            var toolPosition = tool.offset();
            moveTo($(this), { x: toolPosition.left - 20, y: toolPosition.top - 20 });
