...
//********************call message from newb.js and remove sparkling effect
function loadfellowlist(me) {
  ...
  //      getfellowinfo(equipedfellow)
    ...
    $('#equipfellowbtn').bind("click", function() {
         ...
         $('#equipfellowbtn').removeClass('guide_btn_pickfight');
					$('#equipfellowbtn').addClass('con_btn_pickfight');
