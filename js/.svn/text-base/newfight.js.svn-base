	...
	$(document).ready(function()
 {
  ...
  $('#gameover_heal').click(function()
  {
		...
		setTimeout("sleep(getplayer());",2000);
  });  
...
{
	/*
  	$.post("./dispatchers/dispatcher.php", {me: ""+me+"" ,  what: "loadfightend" },
	  	  	 function(data){ exeJSstring(data);	});	
	  	  	 */
			$.ajax({
				dataType: "script",
		  type: "POST",
    ...
    function bigdick(data)
  	...
  	{//debugger;
  		...
  		if(data.msg2user != null)
  		{
    	  				...
    	  				notifyactionresult(data.msg2user);
			}	
      ...
      newbieinstruct13(msg13);//**********end fight message
      fightdisp = new Array();
