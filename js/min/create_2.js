...
{$("#create_btn2").unbind('click');$.post("./dispatchers/dispatcher.php",{roleid:""+roleid+"",gender:""+gender+"",pname:""+pname+"",img:""+imgname+"",promocode:""+promocode+"",what:"createcharacter"},function(data){$('#create_btn2').bind("click",function(){createcharacter();});create_p_res(data);},'json');}}
