...
{var pname=$('#ptextfield').val().trim();gender=getCheckedValue(document.forms['genderradiogroup'].elements['gendergroup']);roleid=getCheckedValue(document.forms['roleradiogroup'].elements['rolegroup']);onclickrole(roleid);if(pname&&pname.length>=9)
