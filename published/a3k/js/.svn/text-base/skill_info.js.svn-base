...
{$.post("./dispatchers/dispatcher.php",{theid:""+theid+"",what:"gettheskillinfo"},function(data){displayaskillinfo(data);},'json');}
...
$.post("./dispatchers/dispatcher.php",{me:""+me+"",skid:""+skid+"",scp:""+scp+"",what:"shortcutskill"},function(data){shortcutresult(data);},'json');}
