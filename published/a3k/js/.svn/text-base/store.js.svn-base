...
{if(theid!=undefined){$.post("./dispatchers/dispatcher.php",{theid:""+theid+"",itemid:""+itemid+"",what:"buystoreitem"},function(data){notifyactionresult(data);exeJSstring(data);getmoneyinfo(getplayer());LoadPlayerInfo(getplayer());},'text');}}
function showtable()
{if(check==0)
