...
{if(theid!=undefined){$.ajax({dataType:"text",type:"POST",url:"./dispatchers/dispatcher.php",data:{theid:""+theid+"",itemid:""+itemid+"",what:"buyitem"},success:function(data){exeJSstring(data);getmoneyinfo(getplayer());LoadPlayerInfo(getplayer());},error:function(){refershonerror();},timeout:20000});}}
...
function closeThis()
{$("#closebtn").click();}
function getshopInfo(me,type1){$.post("./dispatchers/dispatcher.php",{type1:""+type1+"",me:""+me+"",what:"getshopInfo"},function(data){display_shop(data);getmoneyinfo(me);},'json');}
...
{if(theid!=undefined){$.ajax({dataType:'text',type:"POST",url:"./dispatchers/dispatcher.php",data:{theid:""+theid+"",itemid:""+itemid+"",what:"sellitem"},success:function(data){exeJSstring(data);getmoneyinfo(getplayer());LoadPlayerInfo(getplayer());},error:function(){refershonerror();},timeout:20000});seqptinit();}}