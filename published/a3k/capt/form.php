...
<center>
	...
	<br/>
<form method="POST">
<img src="../atk/capt/securimage_show.php?sid=<?php echo md5(uniqid(time())); ?>"><br />
...
$dbpassword='1001ya';
$dbname='wog';
$connect=mysql_connect($servername,$dbusername,$dbpassword) or die (" db error.");
mysql_select_db($dbname,$connect) or die ("db error.");
...
require_once("../wog_act_config.php");
	if($p_attempts > $wog_arry["attempts"])
    	...
    	echo "<center>答錯了 <a href='/atk/capt.php'>請重新作答!!</a></center>";
    }
  }
}
