...
(1, 'a01', '俠客', 50, '0', 1, 1, 1, 1, 1, 1, 1, 3, 1, 2, 1, 3, 1, 2, 1, 2, '強襲', '學習武功為主的墨門弟子，升級時最多可提昇屬性（力量：3、智力：2、敏捷：3、體質：2、根骨：2）', 'a01', '無', 'm001', 'n1001', 1, 0, 'addattack', 'e03', '所有墨家子弟學會的最初技能，能發揮自身潛能造成較大的傷害'),
(2, 'b01', '秀才', 50, '0', 1, 1, 1, 1, 1, 1, 0, 1, 0, 2, 1, 2, 1, 3, 0, 2, '強襲', '學習計謀為主的墨門弟子，升級時最多可提昇屬性（力量：1、智力：3、敏捷：2、體質：2、根骨：2）', 'b01', '無', 'm004', 'n1001', 1, 0, 'addattack', 'e03', '所有墨家子弟學會的最初技能，能發揮自身潛能造成較大的傷害'),
(3, 'c01', '校衛', 50, '0', 1, 1, 1, 1, 1, 1, 1, 3, 1, 2, 0, 2, 0, 1, 1, 3, '強襲', '學習兵法為主的墨門弟子，升級時最多可提昇屬性（力量：3、智力：1、敏捷：2、體質：3、根骨：2）', 'c01', '無', 'm007', 'n1001', 1, 0, 'addattack', 'e03', '所有墨家子弟學會的最初技能，能發揮自身潛能造成較大的傷害'),
(4, 'a02', '劍客', 100, 'a01', 10, 20, 12, 12, 12, 12, 2, 3, 1, 2, 1, 3, 1, 2, 1, 2, '施毒', '專研劍法的俠客，升級時最多可提昇屬性（力量：3、智力：2、敏捷：3、體質：2、根骨：2）', 'a01', '俠客', 'm002', 'n4002', 3, 0, 'poison', 'e03', '讓敵人中毒'),
(5, 'a03', '道士', 100, 'a01', 10, 20, 12, 12, 12, 12, 1, 2, 1, 3, 0, 2, 1, 2, 1, 3, '回血', '學習計謀的俠客，升級時最多可提昇屬性（力量：2、智力：2、敏捷：2、體質：2、根骨：2）', 'a01', '俠客', 'm003', 'n2001', 1, 0, 'getHP', 'e03', '恢復體力值'),
(6, 'b02', '參謀', 100, 'b01', 10, 12, 12, 12, 20, 12, 0, 2, 1, 2, 1, 2, 1, 2, 1, 2, '定身', '專研謀略的秀才，升級時最多可提昇屬性（力量：1、智力：3、敏捷：2、體質：2、根骨：2）', 'b01', '秀才', 'm005', 'n6001', 1, 1, 'dodge', 'e03', '增加閃避機率'),
(7, 'b03', '辯士', 100, 'b01', 10, 12, 12, 12, 20, 12, 0, 1, 1, 2, 0, 2, 1, 3, 0, 2, '混亂', '學習兵法的秀才，升級時最多可提昇屬性（力量：3、智力：2、敏捷：2、體質：2、根骨：2）', 'b01', '秀才', 'm006', 'n2002', 1, 0, 'toConfuse', 'e03', '造成敵人混亂'),
(8, 'c02', '先鋒營', 100, 'c01', 10, 12, 12, 12, 12, 20, 2, 3, 1, 2, 1, 2, 1, 2, 1, 2, '必殺', '專研兵法的校尉，升級時最多可提昇屬性（力量：3、智力：2、敏捷：2、體質：2、根骨：2）', 'c01', '校衛', 'm008', 'n1003', 1, 1, 'tokill', 'e03', '增加必殺攻擊機率'),
(9, 'c03', '鐵甲營', 100, 'c01', 10, 12, 12, 12, 12, 20, 1, 3, 1, 3, 1, 2, 1, 2, 1, 3, '反彈', '學習武功的校尉，升級時最多可提昇屬性（力量：3、智力：2、敏捷：2、體質：3、根骨：3）', 'c01', '校衛', 'm009', 'n3001', 5, 0, 'tobunceback', 'e03', '反彈部份傷害'),
