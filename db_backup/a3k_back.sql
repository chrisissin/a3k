...
-- 
-- Host: localhost
-- Generation Time: Feb 09, 2009 at 02:11 AM
...
INSERT INTO `a3k_fellow` VALUES (1, 20, 20, 10, '獵戶小鐵', 210, 2, 'h0010', 250, 0, 0, 862);
INSERT INTO `a3k_fellow` VALUES (2, 20, 20, 10, '獵戶小鐵', 0, 2, 'h0020', 250, 0, 0, 460);
INSERT INTO `a3k_fellow` VALUES (3, 20, 20, 10, '獵戶小鐵', 248, 2, 'h0030', 250, 0, 0, 209);
INSERT INTO `a3k_fellow` VALUES (5, 20, 20, 10, '獵戶小鐵', 247, 2, 'h0040', 250, 0, 0, 168);
INSERT INTO `a3k_fellow` VALUES (4, 20, 20, 10, '胡車兒', 250, 2, 'h0050', 250, 0, 0, 0);
INSERT INTO `a3k_fellow` VALUES (6, 20, 20, 10, '胡車兒', 250, 2, 'h0060', 250, 0, 0, 0);
INSERT INTO `a3k_fellow` VALUES (7, 20, 20, 10, '胡車兒', 250, 2, 'h0070', 250, 0, 0, 0);
INSERT INTO `a3k_fellow` VALUES (8, 20, 20, 10, '胡車兒', 250, 2, 'h0080', 250, 0, 0, 0);
...
CREATE TABLE `a3k_items` (
  ...
  `item_stackable` tinyint(1) default NULL COMMENT '可否堆疊',
...
INSERT INTO `a3k_items` VALUES (1, '1', 'test head', 1, 1, 'icon_2', 2, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0, 'lnjlhlhjiljlj;', 0);
INSERT INTO `a3k_items` VALUES (2, '2', 'test clothes', 1, 2, 'f0001', 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0, NULL, 0);
INSERT INTO `a3k_items` VALUES (3, '3', 'testte', 1, 1, 'icon_2', 0, 0, 0, 0, 1, 0, 0, 0, 0, NULL, NULL, 0, NULL, 0);
...
INSERT INTO `a3k_monster` VALUES (1, 10, 10, 10, '野熊', 30, 3, '1`2', 60, 'a01', 'n0541', 'a00002`a00003`a00004', 'a00001');
INSERT INTO `a3k_monster` VALUES (5, 12, 12, 10, '山賊嘍嘍', 50, 5, '1`2', 60, 'a01', 'n0330', 'a00001', 'a00005');
...
INSERT INTO `a3k_monster` VALUES (2, 10, 10, 10, '毒蛇', 30, 3, '1`2', 60, 'a01', 'n0550', 'a00003', 'a00002');
INSERT INTO `a3k_monster` VALUES (3, 10, 10, 10, '吃人野熊', 30, 3, '1`2', 60, 'a01', 'n0542', 'a00004', 'a00003');
INSERT INTO `a3k_monster` VALUES (4, 12, 12, 10, '致命毒蛇', 50, 5, '1`2', 60, 'a01', 'n0555', 'a00005', 'a00004');
...
INSERT INTO `a3k_player` VALUES (1, 'chris', 'help@1001ya.com.tw', 29, 25, '', 16, 22, 17, 18, 45, 98, 'a01', 257, 7, 120, 250, 71, 2, 1, '111111', 'p0010', 1228972008, 1224826537, 1230006606, 'a01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 43, 62, 1, '墨門弟子', 17, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (2, 'roo', 'help@1001ya.com.tw', 29, 24, '', 18, 14, 14, 16, 0, 71, 'a01', 166, 4, 126, 175, 22, 16, 1, '111111', 'p0020', 1228972008, 1224826537, 1230006606, 'z01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 47, 47, 2, '墨門弟子', 14, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (3, 'george', 'help@1001ya.com.tw', 18, 14, '', 10, 10, 11, 12, 54, 55, 'b01', 127, 2, 112, 125, 9, 1, 1, '111111', 'p0030', 1228972008, 1224826537, 1230006606, 'a01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 35, 35, 3, '墨門弟子', 11, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (4, 'jack', 'help@1001ya.com.tw', 20, 20, '', 10, 10, 10, 10, 50, 50, 'b01', 100, 1, 0, 100, 0, 0, 1, '111111', 'p0040', 1228972008, 1224826537, 1230006606, 'z01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 30, 30, 4, '墨門弟子', 10, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (5, 'alan', 'help@1001ya.com.tw', 21, 17, '', 13, 12, 11, 10, 55, 58, 'c01', 121, 2, 71, 125, 7, 0, 1, '111111', 'p0050', 1228972008, 1224826537, 1230006606, 'a01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 35, 35, 5, '墨門弟子', 11, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (6, 'eric', 'help@1001ya.com.tw', 20, 20, '', 10, 10, 10, 10, 50, 50, 'c01', 100, 1, 0, 100, 0, 0, 1, '111111', 'p0060', 1228972008, 1224826537, 1230006606, 'z01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 30, 30, 6, '墨門弟子', 10, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (7, 'yao', 'help@1001ya.com.tw', 20, 20, '', 10, 10, 10, 10, 50, 50, 'a01', 100, 1, 0, 100, 0, 0, 1, '111111', 'p0010', 1228972008, 1224826537, 1230006606, 'z01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 30, 30, 7, '墨門弟子', 10, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (8, 'vincent', 'help@1001ya.com.tw', 20, 20, '', 10, 10, 10, 10, 50, 50, 'a01', 100, 1, 0, 100, 0, 0, 1, '111111', 'p0020', 1228972008, 1224826537, 1230006606, 'z01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 30, 30, 8, '墨門弟子', 10, 0, 0, 0, '', 25);
INSERT INTO `a3k_player` VALUES (9, 'alan2', 'help@1001ya.com.tw', 20, 20, '', 10, 10, 10, 10, 50, 50, 'a01', 100, 1, 0, 100, 0, 0, 1, '111111', 'p0030', 1228972008, 1224826537, 1230006606, 'a01', 0, 'NTZkOWQ1NmUtYWY3NC00MDliLTkyOTAtMWE1ZjYxNWViMDQy', 30, 30, 5, '墨門弟子', 10, 0, 0, 0, '', 25);
...
INSERT INTO `a3k_player_item` VALUES (2, 1, 2, 1, NULL);
...
INSERT INTO `a3k_player_item` VALUES (7, 1, 3, 1, NULL);
INSERT INTO `a3k_player_item` VALUES (9, 1, 2, 0, NULL);
...
CREATE TABLE `a3k_quest` (
  ...
  `q_requester` varchar(100) NOT NULL,
  `q_img` varchar(100) NOT NULL,
  `q_map_name` varchar(100) NOT NULL,
  `q_map_id` varchar(100) NOT NULL,
  `q_show_lv` varchar(100) NOT NULL,
  `q_get_lv` varchar(100) NOT NULL,
  `q_limit_job` varchar(100) NOT NULL,
  `q_limit_item` varchar(100) NOT NULL,
  `q_limit_quest` varchar(100) NOT NULL,
  `q_description` varchar(100) NOT NULL,
  `q_dest_map` varchar(100) NOT NULL,
  `q_fight_time` varchar(100) NOT NULL,
  `q_fight_monster` varchar(100) NOT NULL,
  `q_exp` varchar(100) NOT NULL,
  `q_money` varchar(100) NOT NULL,
  `q_fellow` varchar(100) NOT NULL,
  PRIMARY KEY  (`q_id`)
...
INSERT INTO `a3k_quest` VALUES ('q00001', '熊膽孝親', '墨雲師父', '', '墨家邨', 'c1', '3', '4', 'lv4', '', '', '王孝廉的母親病了,徒兒你去飛熊山麓幫他打一些熊膽來給母親燉湯補身吧', '飛熊山麓', '', '殺死3隻野熊', '經驗值500', '', '');
INSERT INTO `a3k_quest` VALUES ('q00002', '斬蛇除害', '墨雲師父', '', '墨家邨', 'c1', '4', '4', 'lv4', '', '', '飛熊山麓最近毒蛇肆虐,徒兒你去幫大夥兒驅蛇除害', '飛熊山麓', '', '殺死5隻致命毒蛇', '錢500', '', '');
INSERT INTO `a3k_quest` VALUES ('q00003', '修行之路', '墨雲師父', '', '墨家邨', 'c1', '1', '0', '每天00:00起可接一次(23:00結束)', '', '', '修行之路就是每天要試煉,現在起每天到飛熊山麓修行,修行完回來找我', '飛熊山麓', '', '戰鬥10場', '經驗值500', '錢500', '');
INSERT INTO `a3k_quest` VALUES ('q00004', '守望相助', '涼州刺史委託信', '', '墨家邨', 'c1', '5', '0', '', '', '', '飛熊山麓最近吃人野熊肆虐,已經傷害數名路人,能除害者有賞', '飛熊山麓', '戰鬥10場', '殺死5隻吃人野熊', '經驗值500', '', '');
INSERT INTO `a3k_quest` VALUES ('q00005', '介紹信', '涼州刺史', '', '墨家邨', 'c1', '5', '5', 'lv5+', '', '', 'XXX(玩家姓名),感謝您的義舉,我的同僚雍州刺史有事相託,我推薦您去,順便在飛熊山麓打個土產幫我帶過去給他', '飛熊山麓', '', '戰鬥1場', '錢500', '', '');
INSERT INTO `a3k_quest` VALUES ('q00006', '維持治安1', '雍州刺史', '', '雍州府', 'c2', '5', '0', '', '', '', '感謝壯士前來,飛熊山麓最近致命毒蛇猖獗,請助我除害', '飛熊山麓', '', '殺死5隻致命毒蛇', '經驗值500', '武器', '');
INSERT INTO `a3k_quest` VALUES ('q00007', '維持治安2', '雍州刺史', '', '雍州府', 'c2', '1', '0', '', '', '', '飛熊山麓最近吃人野熊又出來傷人了,請助我除害', '飛熊山麓', '', '殺死5隻吃人野熊', '經驗值500', '', '學點');
INSERT INTO `a3k_quest` VALUES ('q00008', '維持治安3', '雍州刺史', '', '雍州府', 'c2', '6', '0', '每天每小時可以接一次(每個整點開始結束)', '', '', '這是每小時大放送任務~快去打怪~', '飛熊山麓', '', '殺死4隻山賊嘍嘍', '錢500', '', '學點');
INSERT INTO `a3k_quest` VALUES ('q00009', '職業修行(校尉)', '雍州刺史', '', '雍州府', 'c2', '7', '0', '', '限校尉', '', '這是校尉任務', '飛熊山麓', '', '戰鬥10場', '經驗值500', '錢500', '測試刀*1');
INSERT INTO `a3k_quest` VALUES ('q00010', '職業修行(劍客)', '雍州刺史', '', '雍州府', 'c2', '7', '0', '', '限劍客', '', '這是劍客任務', '飛熊山麓', '', '戰鬥12場', '經驗值500', '錢500', '測試劍*1');
INSERT INTO `a3k_quest` VALUES ('q00011', '職業修行(參謀)', '雍州刺史', '', '雍州府', 'c2', '7', '0', '', '限參謀', '', '這是參謀任務', '飛熊山麓', '', '戰鬥8場', '經驗值500', '錢500', '測試扇*1');
INSERT INTO `a3k_quest` VALUES ('q00012', '緊急招回', '墨雲師父', '', '雍州府', 'c2', '8', '0', '', '', '', '師父有令,殺完山賊嘍嘍回來領紅包', '飛熊山麓', '', '殺死1隻山賊嘍嘍', '經驗值500', '錢500', '測試武將*1');
INSERT INTO `a3k_quest` VALUES ('q00013', '令牌任務', '墨雲師父', '', '墨家邨', 'c1', '1', '0', '', '', '身上有"神秘令牌"', '撿到神祕令牌….究竟能做啥?', '飛熊山麓', '', '殺死2隻山賊嘍嘍', '經驗值500', '錢500', '測試武將*1');
...
CREATE TABLE `a3k_quest_status` (
  ...
  `q_id` varchar(100) NOT NULL,
  `q_status` varchar(100) NOT NULL,
  `q_data` varchar(100) NOT NULL,
  `q_end_time` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `a3k_quest_status` VALUES ('2', 'q00001', '-1', 'a:2:{s:7:"monster";a:0:N;s:5:"fight";i:0;}', '0');
...
INSERT INTO `a3k_skill` VALUES (2, 'a01', 2, 36);
INSERT INTO `a3k_skill` VALUES (3, 'b01', 3, 9);
INSERT INTO `a3k_skill` VALUES (4, 'b01', 4, 0);
INSERT INTO `a3k_skill` VALUES (5, 'c01', 5, 50);
INSERT INTO `a3k_skill` VALUES (6, 'c01', 6, 5);
INSERT INTO `a3k_skill` VALUES (7, 'a01', 7, 0);
INSERT INTO `a3k_skill` VALUES (8, 'a01', 8, 0);
INSERT INTO `a3k_skill` VALUES (9, 'a01', 9, 3);
